import DeviceSensor, { Listener, Subscription } from 'expo-sensors/src/DeviceSensor';
...
export declare enum DeviceMotionOrientation {
    Portrait = 0,
    RightLandscape = 90,
    UpsideDown = 180,
    LeftLandscape = -90
}
export declare class DeviceMotionSensor extends DeviceSensor<DeviceMotionMeasurement> {
    /**
